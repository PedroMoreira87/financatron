...
class ProductAdapter(private val userName: String, private val clickListener:OnClickedListener) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val product = DataModel.instance.getAllProducts(userName)[position]
    ...
    override fun getItemCount(): Int {
        return DataModel.instance.getAllProducts(userName).size
    }
}